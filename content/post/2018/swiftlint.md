---
title: "Swiftlint"
date: 2018-02-19T10:21:18+10:00
lastmod: 2018-02-19T10:21:18+10:00
draft: true
description: ""
tags: []
toc: true
...
Once you decide to write Swiftier code, how do you go about this in a consistent manner?

**Use a style guide.**

Do a search online for [Swift style guide][1] and you will get numerous results, although you do have to dodge the sites dedicated to Taylor Swift's dress sense! I like the [Ray Wenderlich guide][2] although as mentioned, its emphasis is on styles that read well in print and in web pages. The [LinkedIn guide][3] is also good.

But in the end, you have to decide your own style. The important thing then is to be consistent. I don't care whether you use camelCase or snake_case, but if you use a mixture of the two, your code will be harder to read, so pick a style and stick to it.
...
To install SwiftLint, I recommend using [HomeBrew][5]. Once you have HomeBrew installed, open Terminal and type `brew install swiftlint`.

You can run SwiftLine directly from the Terminal. `cd` to the folder containing your Xcode project and type `swiftlint`. For a brand new iOS project, you will probably get a result similar to this:

```text
Linting Swift files in current working directory
Linting 'ViewController.swift' (1/2)
Linting 'AppDelegate.swift' (2/2)
path_to_project/ViewController.swift:23: warning: Vertical Whitespace Violation: Limit vertical whitespace to a single empty line. Currently 2. (vertical_whitespace)
path_to_project/ViewController.swift:25: warning: Trailing Newline Violation: Files should have a single trailing newline. (trailing_newline)
path_to_project/AppDelegate.swift:16: warning: Vertical Whitespace Violation: Limit vertical whitespace to a single empty line. Currently 2. (vertical_whitespace)
path_to_project/AppDelegate.swift:44: warning: Vertical Whitespace Violation: Limit vertical whitespace to a single empty line. Currently 2. (vertical_whitespace)
path_to_project/AppDelegate.swift:46: warning: Trailing Newline Violation: Files should have a single trailing newline. (trailing_newline)
path_to_project/AppDelegate.swift:17: warning: Line Length Violation: Line should be 120 characters or less: currently 144 characters (line_length)
path_to_project/AppDelegate.swift:23: error: Line Length Violation: Line should be 120 characters or less: currently 285 characters (line_length)
path_to_project/AppDelegate.swift:24: warning: Line Length Violation: Line should be 120 characters or less: currently 159 characters (line_length)
path_to_project/AppDelegate.swift:28: error: Line Length Violation: Line should be 120 characters or less: currently 218 characters (line_length)
path_to_project/AppDelegate.swift:29: warning: Line Length Violation: Line should be 120 characters or less: currently 141 characters (line_length)
path_to_project/AppDelegate.swift:33: warning: Line Length Violation: Line should be 120 characters or less: currently 155 characters (line_length)
path_to_project/AppDelegate.swift:37: warning: Line Length Violation: Line should be 120 characters or less: currently 194 characters (line_length)
path_to_project/AppDelegate.swift:41: warning: Line Length Violation: Line should be 120 characters or less: currently 128 characters (line_length)
...
path_to_project/ViewController.swift:22:1 Corrected Vertical Whitespace
path_to_project/ViewController.swift:23 Corrected Trailing Newline
path_to_project/AppDelegate.swift:15:1 Corrected Vertical Whitespace
path_to_project/AppDelegate.swift:43:1 Corrected Vertical Whitespace
path_to_project/AppDelegate.swift:43 Corrected Trailing Newline
...
In the Terminal, `cd` to the folder containing your Xcode project file and run `touch .swiftlint.yml` to create the invisible file. You can edit the file in Terminal using `nano`, `vim` or whatever you prefer, but you can also open it in any text editor. I use Atom so open the file by running this command: `open .swiftlint.yml -a Atom`.
...
* `function_body_length` - the default warning length is 40 but I allow myself 60.
* `line_length` - with a bigger screen, I lengthen both the warning and error lengths.

Now that my .swiftlint.yml file is edited, doing a build uses those settings and for a new iOS project, I am now done to 2 errors and 3 warnings, all due to long lines in AppDelegate.swift.
